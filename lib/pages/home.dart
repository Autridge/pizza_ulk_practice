  ...
  return Column(
    children: [
      Row(
        ...
        children: [
          _buildCategoryButton('🍪 Snack', 'snack'),
          _buildCategoryButton('🥗 Breakfast', 'breakfast'),
        ],
      ),
      const SizedBox(height: 10),
      Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildCategoryButton('🍱 Lunch', 'lunch'),
          _buildCategoryButton('🍽️ Dinner', 'dinner'),
        ],
      ),
    ],
  );
...
Widget _buildCategoryButton(String label, String value) {
  final isSelected = _mealTypeFilter == value;
  return Expanded(
    child: Padding(
      padding: const EdgeInsets.symmetric(horizontal: 4),
      child: ElevatedButton(
        onPressed: () => _filterRecipes(isSelected ? '' : value),
        style: ElevatedButton.styleFrom(
          backgroundColor: isSelected ? Colors.deepOrange.shade100 : Colors.grey.shade200,
